 ...
 */
public class LearnRenderer implements SurfaceHolder.Callback {

    private static final String TAG = LearnRenderer.class.getSimpleName();
    ...
    private final LearnView mLearnView;
    ...
    private final OrientationManager.OnChangedListener mCompassListener =
        ...
        public void onOrientationChanged(OrientationManager orientationManager) {
            mLearnView.setHeading(orientationManager.getHeading());
        ...
        public void onLocationChanged(OrientationManager orientationManager) {
            ...
            //orientationManager.getLocation().gets
        }
     ...
     */
    public LearnRenderer(Context context, OrientationManager orientationManager) {
        LayoutInflater inflater = LayoutInflater.from(context);
        
        mLayout = (FrameLayout) inflater.inflate(R.layout.learn, null);
        mLayout.setWillNotDraw(false);

        mLayout.setOnClickListener(new View.OnClickListener() {

            public void onClick(View v) {
                System.out.println("clocou dentro do renderer do learn!");

            }
        });

        mLearnView = (LearnView) mLayout.findViewById(R.id.learn);
        ...
        mLearnView.setOrientationManager(mOrientationManager);
        mLearnView.setTargetSpeed(LearnService.targetSpeed);
...
//            public void run() {
//            	List<Place> places = mLandmarks.getNearbyLandmarks2(counter);
//        		//System.out.println("atualizou landmarks (t = " + counter + "s)");
...
//	
//	public DownloadFilesTask(Landmarks landmarks, CompassView compassView) {
...
//    	int i = 0;
//    	while(true) {
//    		List<Place> places = mLandmarks.getNearbyLandmarks2(i++);
//    		System.out.println("atualizou landmarks (t = " + i + "s)");
//    		System.out.println(places.size());
//            mCompassView.setNearbyPlaces(places);
//            
//    		try {
